...
export const CampaignCard: React.FC<CampaignCardProps> = ({ campaignAddress }) => {
    ...
    return (
        <div className="flex flex-col justify-between max-w-sm p-6 bg-white border border-slate-200 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div>
                {!isLoadingBalance &&  (
                    <div className="mb-4">
